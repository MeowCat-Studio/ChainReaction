...
public class MenuFragment extends Fragment implements View.OnClickListener {
    ...
    private void setGameInfo() {
        if (chessModel != null) {
            ...
            if (!chessModel.getChessBlood().contains(0)) {
                if (chessModel.getChessRound() % 2 == 0 ^ chessModel.isChessInitiative())
                    color = "<font color=\"#2E9BC6\">蓝方</font>操作";
        ...
        switch (animSpeed) {
            case 0:
                ((TextView) rootLayout.findViewById(R.id.menu_speed_speed)).setText(R.string.menu_speed_fast);
                break;
            case 1:
                ((TextView) rootLayout.findViewById(R.id.menu_speed_speed)).setText(R.string.menu_speed_medium);
                break;
            case 2:
                ((TextView) rootLayout.findViewById(R.id.menu_speed_speed)).setText(R.string.menu_speed_slow);
                break;
        }
    }
    ...
    public void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (resultCode == Activity.RESULT_OK) {
            ...
            menuFragmentListener.onMenuFragmentString((ChessModel) Objects.requireNonNull(data).getSerializableExtra("chessModel"));
        }
    }
