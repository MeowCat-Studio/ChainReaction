...
public class TutorialFragment extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        @SuppressLint("CutPasteId") ObjectAnimator oa1 = ObjectAnimator.ofFloat(rootLayout.findViewById(R.id.tutorial_hint_1), "scaleX", 1f, 2f, 1f);
        oa1.setRepeatCount(ValueAnimator.INFINITE);
        oa1.setDuration(2000);
        oa1.start();
        @SuppressLint("CutPasteId") ObjectAnimator oa2 = ObjectAnimator.ofFloat(rootLayout.findViewById(R.id.tutorial_hint_1), "scaleY", 1f, 2f, 1f);
        oa2.setRepeatCount(ValueAnimator.INFINITE);
        oa2.setDuration(2000);
        oa2.start();
        @SuppressLint("CutPasteId") ObjectAnimator oa3 = ObjectAnimator.ofFloat(rootLayout.findViewById(R.id.tutorial_hint_2), "scaleX", 1f, 2f, 1f);
        oa3.setRepeatCount(ValueAnimator.INFINITE);
        oa3.setDuration(2000);
        oa3.start();
        @SuppressLint("CutPasteId") ObjectAnimator oa4 = ObjectAnimator.ofFloat(rootLayout.findViewById(R.id.tutorial_hint_2), "scaleY", 1f, 2f, 1f);
